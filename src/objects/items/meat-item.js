...
import { BotMeatInputComponent } from '../../components/input/bot-meat-input-component.js';
import { VerticalMovementComponent } from '../../components/movement/vertical-movement-component.js';
import * as CONFIG from '../../config.js';

export class MeatItem extends Phaser.GameObjects.Container {
  #isInitialized;
  #inputComponent;
  ...
  constructor(scene, x, y) {
    ...
    this.#shipSprite = scene.add.sprite(0, 0, 'meat', 0);
  ...
  init(eventBusComponent) {
    ...
    this.#inputComponent = new BotMeatInputComponent();
    this.#verticalMovementComponent = new VerticalMovementComponent(
      this,
      this.#inputComponent,
      CONFIG.ITEM_MEAT_MOVEMENT_VERTICAL_VELOCITY
    );

    this.#healthComponent = new HealthComponent(CONFIG.ITEM_MEAT_HEALTH);
